(function() {
    ...
    module.factory('nzTour', ["$q", "$rootScope", "$compile", "$timeout","$modal", function($q, $rootScope, $compile, $timeout,$modal) {
    ...
    module.directive('nzTour', ["$q", "$compile", function($q, $compile) {
        return {
            ...
            link: function($scope, el) {
                ...
                // Thottle for 60fps
                var onWindowScrollDebounced = $scope.throttle(onWindowScroll, 50);
